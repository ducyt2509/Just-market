              ...
              <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                <div className="aspect-h-3 aspect-w-2 overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5">
                  <img
                    ...
                    src={JSON.parse(offer.product.image[0])[0]}
                    className="object-cover object-center"
                  />
                </div>
                <div className="sm:col-span-8 lg:col-span-7">
                  <h2 className="text-2xl font-bold text-gray-900 sm:pr-12">
                    Offer for {offer.product.productName}
                  </h2>
                  ...
                  >
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      Product Price: {offer.product.price} eth
                    </p>
                    <p className="mt-3 text-base text-gray-500 flex justify-start items-center gap-3">
                      Offer Amount: {offer.amount} eth{' '}
                      <span>
                        {offer.product.price - offer.amount > 0 ? (
                          <ArrowTrendingDownIcon
                            aria-hidden="true"
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      From User: {offer.user.fullName} - {offer.user.email}
                    </p>
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      Created At: {convertDateFormat(offer.createdAt)}
                    </p>
                    <p className="mt-3 text-base text-gray-500">
                      Expired At: {convertDateFormat(offer.expiredAt)}
                    </p>
                  </section>
                </div>
              </div>
