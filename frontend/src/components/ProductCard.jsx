...
export default function ProductCard({
  img , name, owner, currentBid, placeBid
}) {
    return (
        <>
            <div className="flex flex-col justify-center items-center">
                <div className="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 flex flex-col w-full !p-4 3xl:p-![18px] bg-white hover:bg-gray-100">
                    <div className="h-full w-full">
                        <div className="relative w-full">
                            <img
                                src={img}
                                className="mb-3 w-full rounded-xl 3xl:w-full max-h-[184px] object-cover"
                                alt=""
                            />
                        ...
                        <div className="mb-3 flex items-center justify-between px-1 md:items-start">
                            <div className="mb-2">
                                ...
                                <p className="mt-1 text-sm font-medium text-gray-600 md:mt-2">By {owner}</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between md:items-center lg:justify-between">
                            <div className="flex">
                                <p className="!mb-0 text-sm font-bold text-brand-500">
                                    Current Bid: {currentBid} <span>ETH</span>
                                </p>
                            </div>
                            <button
                                href=""
                                className="text-blue-500 linear rounded-[20px] bg-brand-900 px-4 py-2 text-base font-medium text-white transition duration-200 hover:bg-brand-800 active:bg-brand-700"
                            >
                                Place Bid
                            </button>
                        </div>
