...
export default function SignIn() {
    ...
    const [{ data : loginData , error : loginError }, handleLogin] = useAxios(
        {
    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center sm:px-6 lg:px-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            <button
                                ...
                                className={`${
                                    Object.keys(errors).length > 0 ? 'bg-gray-300' : 'bg-indigo-600'
            ...
            {loginError  && <Modal title={'Login Notification'} desc={loginError.response.data.errors[0].message} isError={true} />}
        </div>
    );
}
